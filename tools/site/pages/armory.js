   ...
   confirmed shows as blank instead of a guess. */
{
  ...
  /* A loadout is a primary, a sidearm and a specialist item, and handguns were sitting in
     the primary shelf alongside the rifles. These five are exactly what the Equipment
     Vendor's Sidearm tab lists, read off the game on 2026-09-02: the three handguns plus
     the two GGX machine pistols. Kept here rather than in armory.json because that file is
     generated by tools/build-armory.js and a hand-added field would be overwritten on the
     next pull. */
