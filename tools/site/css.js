...
.vcells{display:grid;grid-template-columns:repeat(3,1fr);gap:4px;background:var(--line);
  border:1px solid var(--line);padding:4px;margin-top:14px;min-height:104px;
  align-content:start}
@media(max-width:899px){.vcells{grid-template-columns:repeat(4,1fr)}}
@media(max-width:420px){.vcells{grid-template-columns:repeat(3,1fr)}}
...
.vcell img{max-width:100%;max-height:44px;object-fit:contain}
