...
.rrow{display:grid;align-items:center;gap:6px 10px;padding:9px 10px;background:var(--panel);
  ...
  grid-template-areas:"name name name name" "track track track track" "load dmg stk rpm"}
...
@media(min-width:760px){
  .rrow{grid-template-columns:210px minmax(120px,1fr) 96px 62px 54px 62px;
    grid-template-areas:"name track load dmg stk rpm";padding:7px 10px}
